...
/***/ "./src/yuna-car-service-faq/block.json":
/*!*********************************************!*\
  !*** ./src/yuna-car-service-faq/block.json ***!
  \*********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"yuna/car-services-faq","version":"0.1.0","title":"F.A.Q","icon":"format-chat","category":"yuna-block-category","description":"F.A.Q","example":{},"attributes":{"anchorId":{"type":"string"},"topIndent":{"enum":["indent-top-big","indent-top-small","indent-top-medium"],"default":"indent-top-big","type":"string"},"bottomIndent":{"enum":["indent-bottom-big","indent-bottom-small","indent-top-medium"],"default":"indent-bottom-big","type":"string"},"blockName":{"type":"string","default":""},"blockTitle":{"type":"string","default":""},"blockText":{"type":"string","default":""},"imageUrl":{"type":"string","default":null},"imageAlt":{"type":"string","default":null}},"supports":{"color":{"background":true,"text":true,"heading":true,"gradients":true},"html":false},"textdomain":"yuna-car-service","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php"}');

/***/ }),

/***/ "./src/yuna-car-service-faq/edit.js":
/*!******************************************!*\
  !*** ./src/yuna-car-service-faq/edit.js ***!
  \******************************************/
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/yuna-car-service-faq/block.json");
...
function Edit({
  ...
  const onSelectImage = media => {
    setAttributes({
      ...
      imageAlt: media && media.alt || ''
    });
  };

  //Inner block
  const cardTemplate = [['yuna/car-service-faq-inner', {}]];
  const ALLOWED_BLOCKS = ['yuna/car-service-faq-inner'];
...
/***/ "./src/yuna-car-service-faq/index.js":
/*!*******************************************!*\
  !*** ./src/yuna-car-service-faq/index.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/yuna-car-service-faq/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/yuna-car-service-faq/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/yuna-car-service-faq/block.json");
...
/***/ "./src/yuna-car-service-faq/style.scss":
/*!*********************************************!*\
  !*** ./src/yuna-car-service-faq/style.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"yuna-car-service-faq/index": 0,
/******/ 			"yuna-car-service-faq/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["yuna-car-service-faq/style-index"], () => (__webpack_require__("./src/yuna-car-service-faq/index.js")))
