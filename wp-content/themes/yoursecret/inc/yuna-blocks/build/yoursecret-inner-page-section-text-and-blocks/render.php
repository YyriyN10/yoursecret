    ...
    <div class="container container px-5">
      <div class="row gx-5 justify-content-center">
        <div class="col-lg-10">
          ...
          <?php if( !empty($attributes['sectionText']) || !empty($attributes['sectionList']) ):?>
            <div class="text">
              <?php if( !empty($attributes['sectionText']) ):?>
	              <?php echo $attributes['sectionText'];?>
              <?php endif;?>
              <?php if( !empty($attributes['sectionList']) ):?>
                <ul>
	                <?php echo $attributes['sectionList'];?>
                </ul>
              <?php endif;?>
            </div>
          <?php endif;?>
          ...
          <?php endif;?>
            ...
            <div class="button-call"><?php echo $attributes['btnCall'];?></div>
	        <?php endif;?>
