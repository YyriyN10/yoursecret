...
/***/ "./src/yuna-step-inner/block.json":
/*!****************************************!*\
  !*** ./src/yuna-step-inner/block.json ***!
  \****************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"yuna-blocks/step-inner","version":"0.1.0","title":"Внутрішня картка","category":"yuna-inner-block-category","icon":"dashicons-block-default","description":"Внутрішня картка","example":{},"attributes":{"itemIconUrl":{"type":"string","default":""},"itemIconId":{"type":"number","default":0},"itemIconAlt":{"type":"number","default":0},"itemName":{"type":"string"},"itemDescription":{"type":"string"},"blockIndex":{"type":"number","default":0}},"usesContext":["yuna/steps:btnContactColor","yuna/steps:btnContactText","yuna/steps:btnContactAnchor","yuna/steps:animationType","yuna/steps:animationEasing","yuna/steps:animationDuration","yuna/steps:animationDelay"],"supports":{"color":{"background":true,"text":true},"spacing":{"padding":true,"margin":true},"html":false},"parent":["yuna-blocks/step"],"textdomain":"yuna","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php"}');

/***/ }),

/***/ "./src/yuna-step-inner/edit.js":
/*!*************************************!*\
  !*** ./src/yuna-step-inner/edit.js ***!
  \*************************************/
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/yuna-step-inner/editor.scss");
...
/***/ "./src/yuna-step-inner/editor.scss":
/*!*****************************************!*\
  !*** ./src/yuna-step-inner/editor.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/yuna-step-inner/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/yuna-step-inner/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/yuna-step-inner/block.json");
...
/***/ "./src/yuna-step-inner/style.scss":
/*!****************************************!*\
  !*** ./src/yuna-step-inner/style.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"yuna-step-inner/index": 0,
/******/ 			"yuna-step-inner/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["yuna-step-inner/style-index"], () => (__webpack_require__("./src/yuna-step-inner/index.js")))
