...
/***/ "./src/yuna-car-service-all-services/block.json":
/*!******************************************************!*\
  !*** ./src/yuna-car-service-all-services/block.json ***!
  \******************************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"yuna/car-service-all-services","version":"0.1.0","title":"Our services","icon":"excerpt-view","category":"yuna-page-block-category","description":"Our services","example":{},"attributes":{"anchorId":{"type":"string"},"topIndent":{"enum":["indent-top-big","indent-top-small"],"default":"indent-top-big","type":"string"},"bottomIndent":{"enum":["indent-bottom-big","indent-bottom-small"],"default":"indent-bottom-big","type":"string"}},"supports":{"color":{"background":true,"text":true,"heading":true,"gradients":true},"html":false},"textdomain":"yuna-car-service","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php"}');

/***/ }),

/***/ "./src/yuna-car-service-all-services/edit.js":
/*!***************************************************!*\
  !*** ./src/yuna-car-service-all-services/edit.js ***!
  \***************************************************/
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/yuna-car-service-all-services/block.json");
...
/***/ "./src/yuna-car-service-all-services/index.js":
/*!****************************************************!*\
  !*** ./src/yuna-car-service-all-services/index.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/yuna-car-service-all-services/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/yuna-car-service-all-services/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/yuna-car-service-all-services/block.json");
...
/***/ "./src/yuna-car-service-all-services/style.scss":
/*!******************************************************!*\
  !*** ./src/yuna-car-service-all-services/style.scss ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"yuna-car-service-all-services/index": 0,
/******/ 			"yuna-car-service-all-services/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["yuna-car-service-all-services/style-index"], () => (__webpack_require__("./src/yuna-car-service-all-services/index.js")))
