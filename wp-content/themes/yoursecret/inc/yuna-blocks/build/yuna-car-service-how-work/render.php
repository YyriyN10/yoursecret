...
<?php if( !empty($attributes['blockTitle']) && !empty($content) && !empty($attributes['imageUrl']) ):?>
	<?php
	...
	>
        ...
        <?php if( !empty($attributes['blockText']) ):?>
          <div class="text col-lg-4 col-md-5" data-aos="fade-up" data-aos-duration="300" data-aos-easing="ease-in"><?php echo $attributes['blockText'];?></div>
        <?php endif;?>
			</div>
      <div class="row">
        <ul class="step-list col-md-6" data-aos="fade-up" data-aos-duration="300" data-aos-easing="ease-in">
	        <?php echo $content; ?>
        </ul>
        <div class="image-wrapper col-md-6" data-aos="fade-up" data-aos-duration="300" data-aos-easing="ease-in">
          <div class="inner">
            <img
