...
/***/ "./src/yuna-clining-servise-price/block.json":
/*!***************************************************!*\
  !*** ./src/yuna-clining-servise-price/block.json ***!
  \***************************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"yuna/yuna-clining-service-price","version":"0.1.0","title":"Вартість послуги","icon":"money-alt","category":"yuna-page-block-category","description":"Вартість послуги","example":{},"attributes":{"anchorId":{"type":"string"},"topIndent":{"enum":["indent-top-big","indent-top-small"],"default":"indent-top-big","type":"string"},"bottomIndent":{"enum":["indent-bottom-big","indent-bottom-small"],"default":"indent-bottom-big","type":"string"},"imageUrl":{"type":"string","default":""},"imageAlt":{"type":"string","default":""},"imageId":{"type":"number","default":0},"blockTitle":{"type":"string"}},"supports":{"color":{"background":true,"text":true,"heading":true,"gradients":true},"html":false},"textdomain":"yuna","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php"}');

/***/ }),

/***/ "./src/yuna-clining-servise-price/edit.js":
/*!************************************************!*\
  !*** ./src/yuna-clining-servise-price/edit.js ***!
  \************************************************/
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/yuna-clining-servise-price/block.json");
...
function Edit({
  ...
  //Inner block
  const cardTemplate = [['yuna/yuna-clining-service-price-inner', {}]];
  const ALLOWED_BLOCKS = ['yuna/yuna-clining-service-price-inner'];
...
/***/ "./src/yuna-clining-servise-price/index.js":
/*!*************************************************!*\
  !*** ./src/yuna-clining-servise-price/index.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/yuna-clining-servise-price/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/yuna-clining-servise-price/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/yuna-clining-servise-price/block.json");
...
/***/ "./src/yuna-clining-servise-price/style.scss":
/*!***************************************************!*\
  !*** ./src/yuna-clining-servise-price/style.scss ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"yuna-clining-servise-price/index": 0,
/******/ 			"yuna-clining-servise-price/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["yuna-clining-servise-price/style-index"], () => (__webpack_require__("./src/yuna-clining-servise-price/index.js")))
