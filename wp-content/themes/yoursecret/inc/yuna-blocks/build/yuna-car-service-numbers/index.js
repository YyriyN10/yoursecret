...
/***/ "./src/yuna-car-service-numbers/block.json":
/*!*************************************************!*\
  !*** ./src/yuna-car-service-numbers/block.json ***!
  \*************************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"yuna/car-service-numbers","version":"0.1.0","title":"Our numbers","icon":"performance","category":"yuna-block-category","description":"Our numbers","example":{},"attributes":{"anchorId":{"type":"string"}},"supports":{"color":{"background":true,"text":true,"heading":true,"gradients":true},"html":false},"textdomain":"yuna-car-service","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php"}');

/***/ }),

/***/ "./src/yuna-car-service-numbers/edit.js":
/*!**********************************************!*\
  !*** ./src/yuna-car-service-numbers/edit.js ***!
  \**********************************************/
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/yuna-car-service-numbers/block.json");
...
function Edit({
  ...
  //Inner block
  const cardTemplate = [['yuna/car-service-numbers-inner', {}]];
...
/***/ "./src/yuna-car-service-numbers/index.js":
/*!***********************************************!*\
  !*** ./src/yuna-car-service-numbers/index.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/yuna-car-service-numbers/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/yuna-car-service-numbers/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/yuna-car-service-numbers/block.json");
...
/***/ "./src/yuna-car-service-numbers/style.scss":
/*!*************************************************!*\
  !*** ./src/yuna-car-service-numbers/style.scss ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"yuna-car-service-numbers/index": 0,
/******/ 			"yuna-car-service-numbers/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["yuna-car-service-numbers/style-index"], () => (__webpack_require__("./src/yuna-car-service-numbers/index.js")))
