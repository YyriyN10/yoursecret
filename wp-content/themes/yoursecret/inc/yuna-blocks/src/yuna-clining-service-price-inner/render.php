...
<li <?php echo $class;?>>
  ...
  <div class="text">
	  ...
	  <?php endif;?>
	  <?php if( !empty($attributes['serviceValue']) ):?>
        <p class="value"><?php echo $attributes['serviceValue'];?></p>
	  <?php endif;?>
  </div>
