 ...
 */
import { InspectorControls, useBlockProps, RichText, MediaUpload, MediaUploadCheck, InnerBlocks} from '@wordpress/block-editor';
...
export default function Edit({ attributes, setAttributes }) {
	...
	const { blockName, blockTitle, blockText, anchorId, topIndent, bottomIndent, imageUrl, imageAlt} = attributes;
