      ...
      <div class="row gx-5 justify-content-center">
        <div class="col-lg-10">
          ...
          <?php if( !empty($attributes['btnText'])):?>
            <form action="/subscribe" method="POST" class="d-flex mt-4 mb-4 align-items-center gap-2">
              <input type="email" name="email" class="form-control" placeholder="<?php echo esc_html( pll__( 'Enter your email' ) ); ?>" required />
